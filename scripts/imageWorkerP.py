...
# peek 100 images first
    ...
    global imageQueue
    print 'expire', expire
    imagesToDevSet = db.gettyImages.find({'has_highres':False, 'refNum':{'$gt':0}, 'processing':False, 'photos':True, 'last_visit':{'$gte':utcMilli()-expire}}).limit(100).sort('last_visit', pymongo.DESCENDING)
...
def main():
    ...
    db.gettyImages.update({'photos':True},{'$set':{'processing':False}}, multi=True)
