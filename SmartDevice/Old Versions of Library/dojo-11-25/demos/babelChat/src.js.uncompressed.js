...
'*now':function(r){r(['dojo/i18n!*preload*demos/babelChat/nls/src*["ar","ca","cs","da","de","el","en-gb","en-us","es-es","fi-fi","fr-fr","he-il","hu","it-it","ja-jp","ko-kr","nl-nl","nb","pl","pt-br","pt-pt","ru","sk","sl","sv","th","tr","zh-tw","zh-cn","ROOT"]']);}
}});
// wrapped by build app
define("demos/babelChat/src", ["dojo","dijit","dojox","dojo/require!dojox/cometd,dojox/rpc/Service,dojox/io/scriptFrame,dojox/widget/Dialog,dojo/fx,dijit/_base/place,dijit/_Widget,dijit/_Templated,dojox/analytics/Urchin"], function(dojo,dijit,dojox){
