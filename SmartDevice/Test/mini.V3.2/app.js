                ...
                window.updatePlayers2 = function()
                {
                    ...
                    dojo.io.script.get(
                    {
						...
						//	loadmetadata();
                            ...
                            if(newdevicecnt==1)
							{
								dojo.byId("wifiscan").innerHTML = newdevicecnt + " Device Unconnected";
							}
							else 
							{
								dojo.byId("wifiscan").innerHTML = newdevicecnt + " Devices Unconnected";
							}
							//if (newdevicecnt>0)
						//		dojo.style("wifiscan", "background-color", "#00C7FF");
						//	else
						//		dojo.style("wifiscan", "background-color", "#504E5B");
                            dojo.create("div",
                            {
...
function emailShare()
{
    ...
    get_short_url(url, login, api_key, function(short_url)
    {
        ...
        calliOSFunction("email", ['Artkick rocks', short_url, encodeURIComponent(imageurl), 'Check out this great image and thousands more at Artkick'], "onSuccess", "onError");
        try
        {
