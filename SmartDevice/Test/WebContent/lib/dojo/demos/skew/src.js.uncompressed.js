...
'demos/skew/src/Image':function(){
// wrapped by build app
define(["dojo","dijit","dojox","dojo/require!dojo/parser,dijit/_Widget,dijit/_Templated,dijit/focus,dojo/fx,dojo/fx/easing"], function(dojo,dijit,dojox){
...
'*now':function(r){r(['dojo/i18n!*preload*demos/skew/nls/src*["ar","ca","cs","da","de","el","en-gb","en-us","es-es","fi-fi","fr-fr","he-il","hu","it-it","ja-jp","ko-kr","nl-nl","nb","pl","pt-br","pt-pt","ru","sk","sl","sv","th","tr","zh-tw","zh-cn","ROOT"]']);}
}});
// wrapped by build app
define("demos/skew/src", ["dojo","dijit","dojox","dojo/require!demos/skew/src/Image,dojo/NodeList-fx,dojo/fx/easing,dojox/widget/Dialog,dojox/layout/RadioGroup,dojox/analytics/Urchin"], function(dojo,dijit,dojox){
