...
'demos/flashCards/src/MathFlashCard':function(){
...
'demos/flashCards/src/Teacher':function(){
// wrapped by build app
define(["dojo","dijit","dojox","dojo/require!dijit/_Widget,dijit/_Templated,dojox/timing/Sequence"], function(dojo,dijit,dojox){
...
'*now':function(r){r(['dojo/i18n!*preload*demos/flashCards/nls/src*["ar","ca","cs","da","de","el","en-gb","en-us","es-es","fi-fi","fr-fr","he-il","hu","it-it","ja-jp","ko-kr","nl-nl","nb","pl","pt-br","pt-pt","ru","sk","sl","sv","th","tr","zh-tw","zh-cn","ROOT"]']);}
}});
// wrapped by build app
define("demos/flashCards/src", ["dojo","dijit","dojox","dojo/require!dojo/parser,dijit/Dialog,dijit/form/Button,dijit/layout/LayoutContainer,dijit/layout/ContentPane,dojox/analytics/Urchin,demos/flashCards/src/MathFlashCard,demos/flashCards/src/Teacher"], function(dojo,dijit,dojox){
