...
function shareVL()
{
	...
	console.log("sharing viewlist "+thislist['name']);
	window.VLsharing=true;
	loadImages(-1,1,15,1);

	//since we are at the showviewlist we don't actually know the images in the viewlist and we want to share the first one as the placeholder for sharing a viewlist
	//so we call getviewlist5 just to get the first image and set up the right stuff for share to work correctly
	showsharemenu();
